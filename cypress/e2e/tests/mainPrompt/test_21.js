...
const test_query_en = 'Give me an article about TypeScript types.'
const test_query_de = 'Gib mir einen Artikel über TypeScript-Typen.'
...
export const test21 = () => {
  ...
  // English query: Give me an article about TypeScript types. elevate user tier
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_21/test_21_en.json', {
        test_id: 'test_021_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-21-typescript-articles-content-type-en')

  // German query: Gib mir einen Artikel über TypeScript-Typen. elevate user tier
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_21/test_21_de.json', {
        test_id: 'test_021_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-21-typescript-articles-content-type-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_21/test_21_explore_en.json', {
        test_id: 'test_021_explore_en',
        query: test_query_en,
  ...
  //Screenshot the response
  cy.screenshot('test-21-typescript-articles-content-type-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_21/test_21_explore_de.json', {
        test_id: 'test_021_explore_de',
        query: test_query_de,
        endpoint: 'reader_explore_text',
        user: { 
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-21-typescript-articles-content-type-explore-de')
} 