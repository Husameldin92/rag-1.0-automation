...
const test_query_en = 'Show me events about Kubernetes.'
const test_query_de = 'Zeig mir Events zu Kubernetes.'
...
export const test18 = () => {
  ...
  // English query: Show me events about Kubernetes. elevate user tier
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_18/test_18_en.json', {
        test_id: 'test_018_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-18-kubernetes-events-access-permissions-en')

  // German query: Zeig mir Events zu Kubernetes. elevate user tier
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_18/test_18_de.json', {
        test_id: 'test_018_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-18-kubernetes-events-access-permissions-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_18/test_18_explore_en.json', {
        test_id: 'test_018_explore_en',
        query: test_query_en,
  ...
  //Screenshot the response
  cy.screenshot('test-18-kubernetes-events-access-permissions-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_18/test_18_explore_de.json', {
        test_id: 'test_018_explore_de',
        query: test_query_de,
        endpoint: 'reader_explore_text',
        user: { 
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-18-kubernetes-events-access-permissions-explore-de')
} 