...
export const test6 = () => {
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_6/test_6_en.json', {
        test_id: 'test_006_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-6-ambiguous-query-angular-better-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_6/test_6_de.json', {
        test_id: 'test_006_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-6-ambiguous-query-angular-better-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_6/test_6_explore_en.json', {
  ...
  //Screenshot the response
  cy.screenshot('test-6-ambiguous-query-angular-better-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_6/test_6_explore_de.json', {
  ...
  //Screenshot the response
  cy.screenshot('test-6-ambiguous-query-angular-better-explore-de')
}