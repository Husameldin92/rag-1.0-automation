...
const test_query_en = 'How do I implement GraphQL caching?'
const test_query_de = 'Wie implementiere ich Caching in GraphQL?'
...
export const test23 = () => {
  ...
  // English query: How do I implement GraphQL caching? elevate user tier
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_23/test_23_en.json', {
        test_id: 'test_023_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-23-graphql-caching-fallback-behavior-en')

  // German query: Wie implementiere ich Caching in GraphQL? elevate user tier
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_23/test_23_de.json', {
        test_id: 'test_023_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-23-graphql-caching-fallback-behavior-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_23/test_23_explore_en.json', {
        test_id: 'test_023_explore_en',
        query: test_query_en,
  ...
  //Screenshot the response
  cy.screenshot('test-23-graphql-caching-fallback-behavior-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_23/test_23_explore_de.json', {
        test_id: 'test_023_explore_de',
        query: test_query_de,
        endpoint: 'reader_explore_text',
        user: { 
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-23-graphql-caching-fallback-behavior-explore-de')
} 