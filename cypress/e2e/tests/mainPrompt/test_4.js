...
export const test4 = () => {
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_4/test_4_en.json', {
        test_id: 'test_004_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-4-dockerfile-common-mistakes-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_4/test_4_de.json', {
        test_id: 'test_004_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-4-dockerfile-common-mistakes-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_4/test_4_explore_en.json', {
  ...
  //Screenshot the response
  cy.screenshot('test-4-dockerfile-common-mistakes-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_4/test_4_explore_de.json', {
        test_id: 'test_004_explore_de',
        query: test_query_de,
        endpoint: 'reader_explore_text',
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-4-dockerfile-common-mistakes-explore-de')
}