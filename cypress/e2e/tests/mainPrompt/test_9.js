...
const test_query_en = 'What changed in Angular 17 Signals?'
const test_query_de = 'Was hat sich bei Angular 17 Signals geändert?'
...
export const test9 = () => {
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_9/test_9_en.json', {
        test_id: 'test_009_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-9-angular-17-signals-changes-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_9/test_9_de.json', {
        test_id: 'test_009_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-9-angular-17-signals-changes-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_9/test_9_explore_en.json', {
        test_id: 'test_009_explore_en',
        query: test_query_en,
  ...
  //Screenshot the response
  cy.screenshot('test-9-angular-17-signals-changes-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_9/test_9_explore_de.json', {
        test_id: 'test_009_explore_de',
        query: test_query_de,
        endpoint: 'reader_explore_text',
        user: { 
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-9-angular-17-signals-changes-explore-de')
} 