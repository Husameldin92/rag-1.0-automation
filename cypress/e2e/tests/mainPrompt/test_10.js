...
export const test10 = () => {
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_10/test_10_en.json', {
        test_id: 'test_010_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-10-angular-signals-generic-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_10/test_10_de.json', {
        test_id: 'test_010_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_10/test_10_explore_en.json', {
        test_id: 'test_010_explore_en',
        query: test_query_en,
  ...
  //Screenshot the response
  cy.screenshot('test-10-angular-signals-generic-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_10/test_10_explore_de.json', {
        test_id: 'test_010_explore_de',
        query: test_query_de,
        endpoint: 'reader_explore_text',
        user: { 
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-10-angular-signals-generic-explore-de')
} 