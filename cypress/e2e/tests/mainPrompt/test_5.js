...
export const test5 = () => {
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_5/test_5_en.json', {
        test_id: 'test_005_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-5-vague-query-whats-up-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_5/test_5_de.json', {
        test_id: 'test_005_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-5-vague-query-whats-up-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_5/test_5_explore_en.json', {
        test_id: 'test_005_explore_en',
        query: test_query_en,
  ...
  //Screenshot the response
  cy.screenshot('test-5-vague-query-whats-up-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_5/test_5_explore_de.json', {
        test_id: 'test_005_explore_de',
        query: test_query_de,
        endpoint: 'reader_explore_text',
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-5-vague-query-whats-up-explore-de')
}