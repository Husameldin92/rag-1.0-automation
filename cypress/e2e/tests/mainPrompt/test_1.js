...
export const test1 = () => {
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_1/test_1_en.json', {
        test_id: 'test_001_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-1-angular-signals-v17-features-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_1/test_1_de.json', {
        test_id: 'test_001_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-1-angular-signals-v17-features-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_1/test_1_explore_en.json', {
  ...
  //Screenshot the response
  cy.screenshot('test-1-angular-signals-v17-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_1/test_1_explore_de.json', {
  ...
  //Screenshot the response
  cy.screenshot('test-1-angular-signals-v17-explore-de')
}