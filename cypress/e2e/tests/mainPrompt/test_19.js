...
const test_query_en = 'Link me a course about Docker on Coursera.'
const test_query_de = 'Gib mir einen Link zu einem Docker-Kurs auf Coursera.'
...
export const test19 = () => {
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_19/test_19_en.json', {
        test_id: 'test_019_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-19-external-sources-coursera-docker-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_19/test_19_de.json', {
        test_id: 'test_019_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-19-external-sources-coursera-docker-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_19/test_19_explore_en.json', {
        test_id: 'test_019_explore_en',
        query: test_query_en,
  ...
  //Screenshot the response
  cy.screenshot('test-19-external-sources-coursera-docker-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_19/test_19_explore_de.json', {
        test_id: 'test_019_explore_de',
        query: test_query_de,
        endpoint: 'reader_explore_text',
        user: { 
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-19-external-sources-coursera-docker-explore-de')
} 