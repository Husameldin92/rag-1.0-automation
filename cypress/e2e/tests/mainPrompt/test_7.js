...
export const test7 = () => {
  ...
  // English query: Give me something cool about tech. elevate user tier
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_7/test_7_en.json', {
        test_id: 'test_007_en',
        query: test_query_en,
        user: {
          tier: 'elevate',
  ...
  cy.screenshot('test-7-generic-tech-requests-en')

  // German query: Zeig mir was Cooles aus der Tech-Welt. elevate user tier
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_7/test_7_de.json', {
        test_id: 'test_007_de',
        query: test_query_de,
        user: {
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-7-generic-tech-requests-de')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_7/test_7_explore_en.json', {
  ...
  //Screenshot the response
  cy.screenshot('test-7-generic-tech-requests-explore-en')
  ...
  cy.get('.markdown-wrapper') 
    .invoke('text')
    .then((actualResponse) => {
      cy.writeFile('rag-ai-evaluator/all_tests/test_7/test_7_explore_de.json', {
        test_id: 'test_007_explore_de',
        query: test_query_de,
        endpoint: 'reader_explore_text',
        user: { 
          tier: 'elevate',
  ...
  //Screenshot the response
  cy.screenshot('test-7-generic-tech-requests-explore-de')
} 