...
const user_login_elevate = 'hosman+new@jax.de'
const user_password = 'Hossamaccent2015+'



it('Test 13: Stress Testing_13', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('what is the best way to learn go?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test13')
    })