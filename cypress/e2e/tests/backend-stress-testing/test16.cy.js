...
const user_login_elevate = 'hosman+rag1@basta.net'
const user_password = 'Hossamaccent2015+'



it('Test 16: Stress Testing_16', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('what is the best way to learn scala?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test16')
    })