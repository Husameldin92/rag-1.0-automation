...
const user_login_elevate = 'hosman+test123@basta.net'
const user_password = 'Hossamaccent2015+'



it('Test 12: Stress Testing_12', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('what is the best way to learn c#?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test12')
    })