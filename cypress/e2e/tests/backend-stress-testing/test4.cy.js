...
const user_login_elevate = 'hosman+rag3@basta.net'
const user_password = 'Hossamaccent2015+'



it('Test 4: Stress Testing_4', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('was ist der unterschied zwischen angular und react?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test4')
    })