...
const user_login_elevate = 'hosman+rag4@basta.net'
const user_password = 'Hossamaccent2015+'



it('Test 5: Stress Testing_5', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('can I attend the next javascript conference?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test5')
    })