...
const user_login_elevate = 'hosman+collection@jax.de'
const user_password = 'Hossamaccent2015+'



it('Test 17: Stress Testing_17', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('what is the best way to learn elixir?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test17')
    })