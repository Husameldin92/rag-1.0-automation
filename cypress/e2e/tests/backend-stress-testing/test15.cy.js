...
const user_login_elevate = 'hosman+newuser1@jax.de'
const user_password = 'Hossamaccent2015+'



it('Test 15: Stress Testing_15', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('what is the best way to learn kotlin?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test15')
    })