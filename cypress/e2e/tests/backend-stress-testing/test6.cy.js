...
const user_login_elevate = 'hosman+rag5@basta.net'
const user_password = 'Hossamaccent2015+'



it('Test 6: Stress Testing_6', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('what is the best way to learn react?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test6')
    })