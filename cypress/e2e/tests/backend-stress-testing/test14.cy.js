...
const user_login_elevate = 'hosman+testticket@jax.de'
const user_password = 'Hossamaccent2015+'



it('Test 14: Stress Testing_14', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('what is the best way to learn rust?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test14')
    })