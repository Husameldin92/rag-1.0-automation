...
const user_login_elevate = 'hosman+rag7@basta.net'
const user_password = 'Hossamaccent2015+'



it('Test 8: Stress Testing_8', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('what is the best way to learn typescript?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test8')
    })