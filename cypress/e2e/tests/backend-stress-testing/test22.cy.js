...
const user_login_elevate = 'hosman+csb@basta.net'
const user_password = 'Hossamaccent2015+'



it('Test 22: Stress Testing_22', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('wie gruppiert man in angular gruppen?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test22')
    })