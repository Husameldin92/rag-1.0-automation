...
const user_login_elevate = 'hosman+rag8@basta.net'
const user_password = 'Hossamaccent2015+'



it('Test 9: Stress Testing_9', () => {
        loginHandel()
  ...
  cy.get('.rounded-0 > .col-12').type('what is the best way to learn python?{enter}')
  cy.wait(50000)
  cy.screenshot('backend-stress-testing-test9')
    })